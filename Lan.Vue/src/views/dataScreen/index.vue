...
<div id="app">
    <div class="dashboard">
      ...
      <div class="panel right-top">
        ...
        <div class="number-display blink">
          3,847<span class="unit">条</span>
        </div>
        <div style="text-align: center; color: #a0d2ff;">今日报警数量</div>
        
        <div class="number-display float">
          128<span class="unit">万</span>
        </div>
...
const echartsRef = ref(null);
        ...
        const initCharts = () => {
          ...
          const populationOption = {
            ...
            yAxis: {
              type: 'category',
              data: ['长沙市', '衡阳市', '株洲市', '湘潭市', '邵阳市', '岳阳市', '常德市', '张家界', '益阳市', '郴州市', '永州市', '怀化市', '娄底市', '湘西州'],
              axisLine: {
                lineStyle: {
                  color: '#4dabf7'
                }
