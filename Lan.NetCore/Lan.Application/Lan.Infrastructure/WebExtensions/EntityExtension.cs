...
namespace Infrastructure
{
    public static class EntityExtension
    {
        public static TSource ToCreate<TSource>(this TSource source, HttpContext? context = null)
        {
            ...
            types.GetProperty("CreateBy", flag)?.SetValue(source, "user", null);
            types.GetProperty("Create_by", flag)?.SetValue(source, "user", null);
            types.GetProperty("DeptId", flag)?.SetValue(source, "id", null);
        ...
        public static TSource ToUpdate<TSource>(this TSource source, HttpContext? context = null)
        {
            ...
            types.GetProperty("UpdateBy", flag)?.SetValue(source, "user", null);
            types.GetProperty("Update_by", flag)?.SetValue(source, "user", null);
