...
namespace Lan.ServiceCore.Services
{
    ...
    public class SysDictDataService : Repository<SysDictData>, ISysDictDataService
    {
        /// <summary>
        /// 查询字典数据
        /// </summary>
        ...
        /// <returns></returns>
        public List<SysDictData> SelectDictDataList(SysDictData dictData, PagerInfo pagerInfo)
        {
