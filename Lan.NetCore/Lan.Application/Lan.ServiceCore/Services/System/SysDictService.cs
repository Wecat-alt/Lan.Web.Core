...
namespace Lan.ServiceCore.Services
{
    ...
    public class SysDictService : Repository<SysDictType>, ISysDictService
    {
        ...
        /// <returns></returns>
        public List<SysDictType> SelectDictTypeList(SysDictType dictType, PagerInfo pager)
        {
            ...
            return null;//GetPages(exp.ToExpression(), pager, f => f.DictId, OrderByType.Desc);
        }
        ...
        {
            return 0;//InsertReturnBigIdentity(sysDictType);
        }
        ...
        public SysDictType GetInfo(long dictId)
        {
            ...
            return null;//GetFirst(f => f.DictId == dictId);
        }
